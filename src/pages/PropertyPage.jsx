            ...
            <div className="propertypage-details">
                ...
                <div className="propertypage-contact" style={{boxShadow: '0 2px 16px rgba(141,90,227,0.10)'}}>
                    ...
                    <div className="propertypage-contact-buttons">
                        <button className="propertypage-contact-btn">📞 Call</button>
                        <button className="propertypage-contact-btn">💬 Message</button>
                        <button className="propertypage-contact-btn">✉️ Email</button>
                        <button className="propertypage-contact-btn">🟢 Whatsapp</button>
                    </div>
                </div>
            </div>
        </div>
